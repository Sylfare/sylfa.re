...
export const ui: {[_ in Language]: i18nKeys} = {
    en: {
        ...
        buttons: {
            ...
            adhd: "available in adHD",
            antinft: "fuck nfts",
            mandatoryFun: "weird al",
            queercoded: "this site is queer coded",
            ublockNow: "download uBlock Origin NOW!",
        },
        navigation: {
            previous: "Previous",
            next: "Next",
    ...
    fr: {
        ...
        buttons: {
            ...
            adhd: "disponible en adHD",
            antinft: "nique les NFTs",
            mandatoryFun: "weird al",
            queercoded: "ce site est queer coded",
            ublockNow: "téchargez uBlock Origin MAINTENANT!",
        },
        navigation: {
            previous: "Précédent",
            next: "Suivant",
